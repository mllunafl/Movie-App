...
public class Movie_wishlistService {
    ...
    public List<Movie_wishlist> findAll() {
        ...
        List<Movie_wishlist> result = movie_wishlistRepository.findAllWithEagerRelationships();
    ...
    public Movie_wishlist findOne(Long id) {
        ...
        Movie_wishlist movie_wishlist = movie_wishlistRepository.findOneWithEagerRelationships(id);
