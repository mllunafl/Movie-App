...
public class Movie_wishlistResource {
    ...
    @Timed
    public ResponseEntity<Movie_wishlist> createMovie_wishlist(@Valid @RequestBody Movie_wishlist movie_wishlist) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<Movie_wishlist> updateMovie_wishlist(@Valid @RequestBody Movie_wishlist movie_wishlist) throws URISyntaxException {
